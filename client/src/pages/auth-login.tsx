          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center mt-6">
              <p className="text-sm text-gray-600">
                En vous connectant, vous acceptez nos <a href="/terms" className="text-ivorian-black hover:underline font-medium">conditions d&apos;utilisation</a> et notre <a href="/privacy-policy" className="text-ivorian-black hover:underline font-medium">politique de confidentialité</a>.
              </p>
            </div>
          </CardContent>
        </Card>
